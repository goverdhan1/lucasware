...
@Repository
public class PackFactorHierarchyComponentDAOImpl extends ResourceDAO<PackFactorHierarchyComponent> implements PackFactorHierarchyComponentDAO {
    ...
    public List<PackFactorHierarchyComponent> getPackFactorHierarchyComponentListBySearchAndSortCriteria(SearchAndSortCriteria searchAndSortCriteria) throws ParseException {
        final List<PackFactorHierarchyComponent> componentList = this.getBySearchAndSortCriteria(searchAndSortCriteria);
