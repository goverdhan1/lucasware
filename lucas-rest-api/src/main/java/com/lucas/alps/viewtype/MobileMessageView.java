...
/**
 * @Author Pedda
 * @Product Lucas. Created By: Pedda Created On Date: 15/06/2015 This Class provide the
 *          implementation for the functionality of Rendering the Device Message Set Options in the
 *          form of the Json.
 */

public interface MobileMessageView extends BaseView {
