...
public class EquipmentManagerController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(EquipmentManagerController.class);
    ...
    @Inject
    public EquipmentManagerController(EquipmentService equipmentTypeService, MessageSource messageSource) {
