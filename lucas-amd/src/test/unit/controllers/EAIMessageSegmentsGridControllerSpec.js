...
describe('EAIMessageSegmentsGrid Controller Unit Tests', function() {

    // Global vars
    var def = null;
    var localEAIMessageSegmentsGridController = null;
    var scope = null;
        ...
        scope.widgetdetails = {
            ...
            "widgetDefinition": {
                ...
                "dataURL": {
                    ...
                    "url": "/messagesegments/messagesegment-list/search"
                },
                "reactToMap": {
                    "groupName": {
                        "searchCriteria": {
    ...
    // Inject Specs
    describe('EAIMessageSegments Grid Injection Specs', function() {

        beforeEach(inject(function($controller) {
            localEAIMessageSegmentsGridController = $controller('EAIMessageSegmentsGridController', {
                $scope: scope,
    ...
    describe('EAIMessageSegments Grid updateExistingWidget test', function() {
