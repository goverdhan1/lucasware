...
describe('EAIEventHandlersGrid Controller Unit Tests', function() {

    // Global vars
    var def = null;
    var localEAIEventHandlersGridController = null;
    var scope = null;
    ...
    beforeEach(inject(function(_$controller_, _$rootScope_, _UtilsService_, _WidgetGridService_, _$modal_, _WidgetService_, _uiGridConstants_, $httpBackend) {
        ...
        scope.widgetdetails = {
            ...
            "widgetDefinition": {
                ...
                "widgetActionConfig": {
                    "widget-access": {
                        "eai-event-handlers-grid-widget-access": true
                    },
                    "widget-actions": {
                        "edit-group": true,
                        "create-group": true,
    ...
    // Inject Specs
    describe('EAIEventHandlers Grid Injection Specs', function() {

        beforeEach(inject(function($controller) {
            localEAIEventHandlersGridController = $controller('EAIEventHandlersGridController', {
                $scope: scope,
    ...
    describe('EAIEventHandlers Grid updateExistingWidget test', function() {
