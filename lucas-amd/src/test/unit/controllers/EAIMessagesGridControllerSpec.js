...
describe('EAIMessagesGrid Controller Unit Tests', function() {

    // Global vars
    var def = null;
    var localEAIMessagesGridController = null;
    var scope = null;
        ...
        scope.widgetdetails = {
            ...
            "widgetDefinition": {
                ...
                "dataURL": {
                    ...
                    "url": "/messages/message-list/search"
                },
                "reactToMap": {
                    "groupName": {
                        "searchCriteria": {
    ...
    // Inject Specs
    describe('EAIMessages Grid Injection Specs', function() {

        beforeEach(inject(function($controller) {
            localEAIMessagesGridController = $controller('EAIMessagesGridController', {
                $scope: scope,
    ...
    describe('EAIMessages Grid updateExistingWidget test', function() {
