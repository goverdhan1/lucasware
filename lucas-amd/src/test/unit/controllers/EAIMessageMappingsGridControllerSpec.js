...
describe('EAIMessageMappingsGrid Controller Unit Tests', function() {

    // Global vars
    var def = null;
    var localEAIMessageMappingsGridController = null;
    var scope = null;
    ...
    beforeEach(inject(function(_$controller_, _$rootScope_, _UtilsService_, _WidgetGridService_, _$modal_, _WidgetService_, _uiGridConstants_, $httpBackend) {
        ...
        scope.widgetdetails = {
            ...
            "widgetDefinition": {
                ...
                "widgetActionConfig": {
                    "widget-access": {
                        "eai-message-mappings-grid-widget-access": true
                    },
                    "widget-actions": {
                        "edit-group": true,
                        "create-group": true,
    ...
    // Inject Specs
    describe('EAIMessageMappings Grid Injection Specs', function() {

        beforeEach(inject(function($controller) {
            localEAIMessageMappingsGridController = $controller('EAIMessageMappingsGridController', {
                $scope: scope,
    ...
    describe('EAIMessageMappings Grid updateExistingWidget test', function() {
