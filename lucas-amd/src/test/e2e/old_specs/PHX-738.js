...
xdescribe('phx-738 search user grid widget reacttomap, listensforlist e2e tests', function() {
	//Test setup
	beforeEach(function() {
		browser.get('');
	...
	describe('search user grid widget ', function() {
		beforeEach(function() {
		...
		it('ensure listensForList is populated in dropdown, allows user to delete an item, shows save button, and clicks save button', function() {
			...
			expect(element(by.css('.modal-header h4')).getText()).toBe("search-user-grid-widget");
			...
			expect(element(by.css('#wid100 .panel-heading')).getText()).toBe("search-user-grid-widget, 100");
