...
xdescribe('phx-737 create edit user form reacttomap, listensforlist e2e tests', function() {
	//Test setup
	beforeEach(function() {
		browser.get('');
	...
	describe('create edit user form widget ', function() {
		beforeEach(function() {
		...
		it('ensure listensForList is populated in dropdown, allows user to delete an item, shows save button, and clicks save button', function() {
			...
			expect(element(by.css('.modal-header h4')).getText()).toBe("create-or-edit-user-form-widget");
			...
			expect(element(by.css('#wid100 .panel-heading')).getText()).toBe("create-or-edit-user-form-widget, 100");
