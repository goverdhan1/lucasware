...
amdApp.controller('EquipmentTypeGridController', ['$rootScope', '$log', '$scope', '$compile', 'WidgetGridService', 'UtilsService', 'LocalStoreService', '$modal', 'WidgetService', 'uiGridConstants', '$timeout',
    function(rootScope, log, scope, compile, WidgetGridService, UtilsService, LocalStoreService, modal, WidgetService, uiGridConstants, timeout) {
        ...
        scope.gridOptions = WidgetGridService.getDefaultGridOptions('equipment-type-grid');
        ...
        //load Equipment Type records from DB
