...
amdApp.controller('EAIMessageSegmentsGridController', ['$rootScope', '$log', '$scope', '$compile', 'WidgetGridService', 'UtilsService', 'LocalStoreService', '$modal', 'WidgetService', 'uiGridConstants', '$timeout',
    function(rootScope, log, scope, compile, WidgetGridService, UtilsService, LocalStoreService, modal, WidgetService, uiGridConstants, timeout) {
        ...
        scope.gridOptions = WidgetGridService.getDefaultGridOptions('message-segments-grid');
        ...
        //load Message Segment records from DB
        scope.loadRecords = function(append) {
            ...
            WidgetGridService.getEAIMessageSegments(scope.widgetdetails, sort, filter, page, size)
        ...
        scope.launchMessageSegmentDefinitionButton = function() {
            return scope.selectedRows.length == 1;
        };

        scope.launchMessageSegmentDefinition = function() {
            modal.open({
                templateUrl: 'views/modals/eai-message-segment-definition.html',
                controller: 'EaiMessageSegmentDefinitionModalController',
                backdrop: 'static',
        ...
        var actionButtons='<button class="btn-small btn-success" id="launchMessageSegmentDefinition" ng-click="launchMessageSegmentDefinition()" ng-if="launchMessageSegmentDefinitionButton()" tooltip-placement="right" tooltip-append-to-body="true" tooltip="Definition"><i class="glyphicon glyphicon-list"></i></button>';
