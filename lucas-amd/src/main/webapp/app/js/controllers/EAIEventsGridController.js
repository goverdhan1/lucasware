...
amdApp.controller('EAIEventsGridController', ['$rootScope', '$log', '$scope', '$compile', 'WidgetGridService', 'UtilsService', 'LocalStoreService', '$modal', 'WidgetService', 'uiGridConstants', '$timeout',
    function(rootScope, log, scope, compile, WidgetGridService, UtilsService, LocalStoreService, modal, WidgetService, uiGridConstants, timeout) {
        ...
        scope.gridOptions = WidgetGridService.getDefaultGridOptions('event-grid');
        ...
        scope.loadRecords = function(append) {
            ...
            WidgetGridService.getEAIEvents(scope.widgetdetails, sort, filter, page, size)
        ...
        scope.launchEventDefinitionButton = function() {
            return scope.selectedRows.length == 1;
        };

        scope.launchEventDefinition = function(index) {
            modal.open({
                templateUrl: 'views/modals/eai-event-definition.html',
                controller: 'EAIEventDefinitionModalController',
                backdrop: 'static',
        ...
        var actionButtons = '<button class="btn-small btn-success" id="launchEventDefinition" ng-click="launchEventDefinition()" ng-if="launchEventDefinitionButton()" tooltip-placement="right" tooltip-append-to-body="true" tooltip="Definition"><i class="glyphicon glyphicon-list"></i></button>' +
                            '<button class="btn-small btn-success" id="launchEventDefinitionNew" ng-click="launchEventDefinition(0)" tooltip-placement="right" tooltip-append-to-body="true" tooltip="New"><span>New</span></button>';
