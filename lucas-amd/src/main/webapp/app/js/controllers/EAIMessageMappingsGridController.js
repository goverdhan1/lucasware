...
amdApp.controller('EAIMessageMappingsGridController', ['$rootScope', '$log', '$scope', '$compile', 'WidgetGridService', 'UtilsService', 'LocalStoreService', '$modal', 'WidgetService', 'uiGridConstants', '$timeout',
    function(rootScope, log, scope, compile, WidgetGridService, UtilsService, LocalStoreService, modal, WidgetService, uiGridConstants, timeout) {
        ...
        scope.gridOptions = WidgetGridService.getDefaultGridOptions('message-mapping-grid');
        ...
        //load Message Mapping records from DB
        scope.loadRecords = function(append) {
            ...
            WidgetGridService.getEAIMessageMappings(scope.widgetdetails, sort, filter, page, size)
