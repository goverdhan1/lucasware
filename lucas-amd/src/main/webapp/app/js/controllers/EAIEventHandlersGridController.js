...
amdApp.controller('EAIEventHandlersGridController', ['$rootScope', '$log', '$scope', '$compile', 'WidgetGridService', 'UtilsService', 'LocalStoreService', '$modal', 'WidgetService', 'uiGridConstants', '$timeout',
    function(rootScope, log, scope, compile, WidgetGridService, UtilsService, LocalStoreService, modal, WidgetService, uiGridConstants, timeout) {
        ...
        scope.gridOptions = WidgetGridService.getDefaultGridOptions('eai-event-handler-grid');
        ...
        //load Event Handler records from DB
        scope.loadRecords = function(append) {
            ...
            WidgetGridService.getEAIEventHandlers(scope.widgetdetails, sort, filter, page, size)
        ...
        scope.launchEventHandlerRegistrationButton = function() {
            return scope.selectedRows.length == 1;
        };

        scope.launchEventHandlerRegistration = function(index) {
            modal.open({
                templateUrl: 'views/modals/eai-event-handler-registration.html',
                controller: 'EAIEventHandlerRegistrationModalController',
                backdrop: 'static',
        ...
        var actionButtons = '<button class="btn-small btn-success" id="launchEventHandlerRegistration" ng-click="launchEventHandlerRegistration()" ng-if="launchEventHandlerRegistrationButton()" tooltip-placement="right" tooltip-append-to-body="true" tooltip="Definition"><i class="glyphicon glyphicon-list"></i></button>' +
                            '<button class="btn-small btn-success" id="launchEventHandlerRegistrationNew" ng-click="launchEventHandlerRegistration(0)" tooltip-placement="right" tooltip-append-to-body="true" tooltip="New"><span>New</span></button>';
